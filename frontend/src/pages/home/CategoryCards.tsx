...
const categoryIcons: { [key in ItemCategory]: React.ReactNode } = {
  BREAKFAST: (
    <div className="bg-cheko-pink rounded-xl my-auto w-14 h-14 ">
      {" "}
      <Croissant
        size={30}
  ...
  DRINK: (
    <div className=" bg-cheko-light-blue rounded-xl my-auto w-14 h-14  ">
      {" "}
      <Coffee
        size={30}
        className="bg-cheko-light-blue  m-auto mt-3 text-black"
      />
    </div>
  ),
  SOUP: (
    <div className="bg-cheko-light-mauve rounded-xl my-auto w-14 h-14  ">
      {" "}
      <Soup
        size={30}
        className="bg-cheko-light-mauve  m-auto mt-3  text-black"
      />
    </div>
  ),
  SUSHI: (
    <div className="bg-cheko-lavender rounded-xl  my-auto w-14 h-14">
      {" "}
      <UtensilsCrossed
        size={30}
        className="bg-cheko-lavender  m-auto mt-3 text-black"
      />{" "}
    </div>
  ),
  OTHER: (
    <div className="bg-cheko-teal rounded-xl  my-auto w-14 h-14">
      {" "}
      <Wheat size={30} className="bg-cheko-teal  m-auto mt-3 text-black" />{" "}
    </div>
  ),
};
        ...
        return (
          <div
            ...
            className={`flex items-center justify-start max-w-64 space-x-2 rounded-lg px-2.5 py-2 text-sm font-medium shadow ${
              isDarkMode
                ? "bg-cheko-card-gray text-gray-200"
                : "bg-white text-black"
            }`}
          >
            {categoryIcons[cat]}
