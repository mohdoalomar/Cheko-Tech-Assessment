...
public class LocationServiceTest {
    ...
    void filterLocationByDistance_ShouldFilterByDistance() {
        ...
        List<LocationDTO> result = locationService.filterLocationByDistance(
                24.5098, 46.6169, 1.0, null);
    ...
    void calculateDistance_ShouldReturnCorrectDistance_Riyadh() {
        ...
        Location olayaLocation = Location.builder()
                .id(1L)
                .latitude(lat1)
                .longitude(lon1)
                .imageUrl("olaya.jpg")
        ...
        Location malazLocation = Location.builder()
                .id(2L)
                .latitude(lat2)
                .longitude(lon2)
                .imageUrl("malaz.jpg")
        ...
        Location dirabLocation = Location.builder()
                .id(3L)
                .latitude(lat3)
                .longitude(lon3)
                .imageUrl("dirab.jpg")
        ...
        List<LocationDTO> resultSmallDistance = locationService.filterLocationByDistance(lat1, lon1, 1.0, null);
        ...
        List<LocationDTO> resultLargeDistance = locationService.filterLocationByDistance(lat1, lon1, 10.0, null);
