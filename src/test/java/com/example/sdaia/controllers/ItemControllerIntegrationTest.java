...
public class ItemControllerIntegrationTest {
    ...
    void getItems_ShouldReturnItemPageResponseDTO() throws Exception {
        ...
        ItemPageResponseDTO responseDTO = ItemPageResponseDTO.builder()
                .items(itemPage)
                .counts(counts)
                .build();
    ...
    void getSecondHighestCalorieItemPerCategory_ShouldReturnMapOfItems() throws Exception {
        ItemDTO breakfastItem = ItemDTO.builder()
                .id(1L)
                .name("Breakfast Item")
        ...
        ItemDTO drinkItem = ItemDTO.builder()
                .id(2L)
                .name("Drink Item")
                .description("Description")
                .imageUrl("image2.jpg")
        ...
        mockMvc.perform(get("/item/second_highest_calorie"))
                .andExpect(status().isOk())
